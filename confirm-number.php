...
<head>
    ...
    <link rel="stylesheet" href="css/confirm-number.css">
    <title>Grootech | Login</title>
</head>
<body>
                ...
                <form action="" class="form">
                    ...
                    <div class="form__body">
                        ...
                        <div class="form__grid">
                            <input type="text" class="form__input" name="digit-1">
                            <input type="text" class="form__input" name="digit-2">
                            <input type="text" class="form__input" name="digit-3">
                            <input type="text" class="form__input" name="digit-4">
                            <input type="text" class="form__input" name="digit-5">
                            <input type="text" class="form__input" name="digit-6">
                        </div>
    ...
    <footer class="footer">
        <ul class="footer__list">
            ...
            <li class="footer__item">
                <a href="" class="footer__link" name="Explore">
                    <span class="icon">
            ...
            <li class="footer__item">
                <a href="" class="footer__link" name="sign-up">
                    <span class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                    </span>
                    <span class="text">
