...
<head>
    ...
    <link rel="stylesheet" href="css/finalize-login.css">
    <title>Grootech | Signing Up</title>
</head>
<body>
                ...
                <form action="" class="form">
                    ...
                    <div class="form__body">
                        <div class="form__group u-mt-sm form__group--no-margin-bottom form__group--border-top form__group--border-top-radius form__group--border-round-top form__group--border-bottom">
                            ...
                            <input type="text" class="form__input" id="first-name" placeholder="John" name="first-name">
                        </div>
                        <div class="form__group form__group--no-margin-bottom form__group--border-round-bottom form__group--border-bottom form__group--border-bottom-radius">
                            ...
                            <input type="text" class="form__input" placeholder="Doe" name="last-name">
                        </div>
                        <p class="form__text">
                            Make sure it matches the name on your government ID.
                        </p>
                        <div class="form__box">
                            <label for="birthday" class="form__label--lg">
                                <span class="text">
                                    Birthday
                                </span>
                                <span class="icon">
