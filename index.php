                ...
                <div class="header__wrapper">
                    <div class="header__logo">
                        <a href="" class="header__logo-link">
                            <svg class="header__logo-image" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 178.43 178.43"><defs><style>.cls-3{fill:var(--logo__white--1);}.cls-4{fill:var(--logo__white--2);}</style></defs><title>Asset 1</title><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><path class="cls-3" d="M57.17,89.22H0A89.21,89.21,0,0,1,143.06,18.09l-41.4,41.59A32,32,0,0,0,57.17,89.22Z"/><path class="cls-4" d="M178.43,89.22v89.21H121.26V172.5A89.32,89.32,0,0,1,35.1,160.14L76.44,118.6a32,32,0,0,0,44.82-29.39Z"/></g></g></svg>
                            <p class="header__logo-text header__logo-text--white">
                                Grootech
                            </p>
                        </a>
                    </div>
                    <nav class="nav">
                        <ul class="nav__list">
                            <li class="nav__item">
                                <a href="" class="nav__link" name="Opportunities">
                                    Opportunities 
                                </a>
                            </li>
                            <li class="nav__item">
                                <a href="" class="nav__link" name="Discover">
                                    Discover
                                </a>
                            </li>
                            <li class="nav__item">
                                <button class="nav__button nav--active">
            ...
            <div class="header__search-box">
                <form action="" class="header__search">
                    <div class="header__box">
                        ...
                        <div class="header__group">
                            <div class="header__container header__container--tag">
                                <label for="tag" class="header__label">
                                    Keyword
                                </label>
        ...
        <div class="banner">
            ...
            <div class="banner__overlay">
                ...
                <div class="banner__link-box">
                    <a href="" class="banner__link" name="Explore">
                        <span>
                            Explore
                        </span>
                    </a>
