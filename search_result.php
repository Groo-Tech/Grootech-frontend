...
<body>
    <header class="header">
        <div class="header__wrapper">
            ...
            <div class="options">
                <button class="options__location">
                    <span>
                        Lagos
                    </span>
                </button>
                <span class="options__border">&nbsp;</span>
                <button class="options__dates">
                    <span>
                        Add Date
                    </span>
                </button>
    ...
    <section class="section-results">
        <div class="results">
            <div class="results__content">
                <p class="results__overview">
                    300+ Farms in map area.
                </p>
                <p class="results__policy">
                    Read about our Privacy Policy.
                    <a href="" class="" name="Learn more">
                        Learn More
                    </a>
                </p>
                <ul class="results__list">
                    <li class="results__item">
                        ...
                        <div class="results__details">
                            <div class="results__favourite">
                                <button class="icon-favourite">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--grootech__gray)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-heart"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>
                                </button>
                            </div>
                            <div class="">
                                <p class="results__paragraph">
                                    Entire unit in Lagos
                                </p>
                                <h1 class="results__heading">
                                    Agbalanjo Farms (ka sa ma du pe)
                                </h1>
                                <ul class="results__tags">
                                    <li class="results__tag">
                                        Cattle Farming
                                    </li>
                                    <li class="results__tag">
                                        Poultry Farming
                    ...
                    <li class="results__item">
                        ...
                        <span class="results__image-box">
                            ...
                            <img src="./assets/images/cities/grootech__city--5.jpg" alt="Cattle Farm" class="results__image">
                            <img src="./assets/images/cities/grootech__city--6.jpg" alt="Cattle Farm" class="results__image">
                            <img src="./assets/images/cities/grootech__city--7.jpg" alt="Cattle Farm" class="results__image">
                            <img src="./assets/images/cities/grootech__city--8.jpg" alt="Cattle Farm" class="results__image">
                            <img src="./assets/images/cities/grootech__city--4.jpg" alt="Cattle Farm" class="results__image">
                            <img src="./assets/images/cities/grootech__city--2.jpg" alt="Cattle Farm" class="results__image">
                            <span class="results__controls">
                                <button class="results__dot results__dot--active">
